DROP DATABASE Specification_db;
CREATE DATABASE Specification_db;
use Specification_db;
...
CREATE TABLE `customers` (
  ...
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`sales_rep_employee_number`) REFERENCES `employees` (`employeeNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `payments`(`customer_number`,`checkNumber`,`paymentDate`,`amount`) values
